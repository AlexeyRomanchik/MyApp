...
{
    public class MotherboardSortService : ProductSortService<Motherboard>, IMotherboardSortService
    {
        public override IQueryable<Motherboard> SortBy(SortState sortState, IQueryable<Motherboard> products)
        {
            switch (sortState)
            {
